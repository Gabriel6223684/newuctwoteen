...
class SelectQuery
{
    ...
    public function fetch($IsArray = true)
    {
        ...
        try {
            ...
            // Usamos executeQuery enviando os binds diretamente na conexão
            $result = $connection->executeQuery($query, $this->binds);
    ...
    public function fetchAll($IsArray = true)
    {
        ...
        try {
            ...
            // Executa e obtém todos os registros mapeados
            $result = $connection->executeQuery($query, $this->binds);
